...
const CONFIG = {
  ...
  REPORT_WITHOUT_BACKING_TITLE: '## ⚠️ Dependencies with Wishlists (no maintainer Big Tech email alias)',
  REPORT_WITHOUT_BACKING_DESCRIPTION: 'These packages have wishlists but no maintainers using Big Tech email aliases:',
  REPORT_WITH_BACKING_TITLE: '## ✅ Dependencies with Wishlists (maintainer Big Tech email alias)',
